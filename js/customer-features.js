var cfDataset = [
  ...
  },
  {
    ...
    "body": "Comes with Haven already installed. Unbox it, plug it in, and it's ready before any device connects — then you choose what to filter. Haven never makes that choice for you.",
    "family_rank": 2,
    "privacy_rank": 2,
    "family_lead": null,
    "privacy_lead": null,
    "link": null,
    "details": "<p>Plug in the power, connect to your modem the same way your old router did, set a Wi-Fi password, then choose what to filter. Haven seeks the same subnet that was in use. No flashing firmware, no following a YouTube tutorial, no command-line, no DNS settings to change on every device you own.</p><p>The filtering runs at Haven itself, ahead of any device. So filtering is in effect from the very first connection, before a single phone touches the network.</p>",
    "image": null,
  ...
  },
  {
    ...
    "privacy_lead": null,
    "link": null,
    "details": "<p>If you want a safety net for your settings — protection against your Haven failing, a fire, a move — turn on encrypted cloud backup. Haven encrypts a copy of your settings with a key that never leaves Haven itself, then ships the encrypted blob up to Haven Inc. We store it. We cannot decrypt it.</p><p>To restore: print or save your recovery phrase from the Helm. That phrase is the only thing that can unlock the backup. Lose the phrase, lose the backup — and that is the point. If we could unlock it for you, so could anyone else with the right court order.</p>",
    "image": null,
    "milestone_ids": "112",
    "wiki_slug": null,
    "benefits": [
  ...
  },
  {
    ...
    "body": "coming soon: an app that carries your channel choices onto YouTube on your own devices",
    "family_rank": 23,
    "privacy_rank": 4,
    "family_lead": null,
    "privacy_lead": null,
    "link": null,
    "details": "<p>Coming soon: U-Haven, a companion app that carries the channel choices you set in Haven onto YouTube on your own devices — hiding channels from the home feed, the recommendations, the sidebar. The same values you set on your network, applied where you actually watch.</p><p>It pairs with the router-level filtering: Haven blocks the apps you decided not to have at all, and U-Haven will shape what the apps you do allow show you.</p>",
    "image": null,
  ...
  },
  {
    ...
    "body": "Caregiver (supervising another person's access) · Fraud (scam and clickbait protection) · School (homework focus) · Workplace (distraction control) · Recovery (support staying away from chosen triggers)",
    "family_rank": 6,
    "privacy_rank": 35,
    "family_lead": null,
    "privacy_lead": null,
    "link": null,
    "details": "<p>Templates are starting points, not lock-ins. Each one flips a thoughtful set of category toggles in a single click — useful when you do not feel like reading every bullet from scratch.</p><ul><li><strong>Caregiver.</strong> Adult content, gambling, mobile game ads, misinformation off by default.</li><li><strong>Fraud.</strong> Scam sites, crypto pump-and-dump, fake-virus pop-ups, fake invoices, \"your computer is infected\" pages — all turned off. Built around the kinds of attacks designed to separate people from their money.</li><li><strong>School.</strong> Blocks games and social media so schoolwork gets the screen.</li></ul><p>Apply a template, then refine. Anything a template turned on, you can turn back off individually.</p>",
    "image": null,
  ...
  },
  {
    ...
    "privacy_lead": null,
    "link": null,
    "details": "<p>Every device that joins your network — Wi-Fi or Ethernet — shows up in the device picker on the Helm, named the way the device announced itself (\"Sarah's iPhone,\" \"Roku Ultra\"). Give it your own name once and Haven remembers it. Useful when a guest brings a tablet, when a new smart-home gadget arrives, or when something is connecting that nobody on-site can identify.</p>",
    "image": null,
  ...
  },
  {
    ...
    "body": "the Helm shows what you need and nothing else — a deeper Advanced mode is coming",
    "family_rank": 3,
    "privacy_rank": 3,
    "family_lead": null,
    "privacy_lead": null,
    "link": null,
    "details": "<p>The Helm shows the category toggles, the templates, the always-allow list, the alerts page, and the activity feed. That is enough for most networks on most days, and it is the whole point: click, save, live your life.</p><p>An Advanced mode with deeper controls is coming. Simple is not the starter tier — it is the product, and it will stay this simple.</p>",
    "image": null,
  ...
  },
  {
    ...
    "privacy_lead": null,
    "link": null,
    "details": "<p>Pick a device from the device picker on the Helm and set its own category rules — one person's phone can run stricter rules than the shared TV, and filtering can be switched on or off per device. Every device you have not singled out keeps the shared network-wide rules.</p><p>Per-device rules are only safe when device identification is reliable, so they lean on the same device list you already curate: devices show up when they join, you name them once, and the rules follow the name.</p>",
    "image": null,
  ...
  },
  {
    "id": 36,
    "section": "main",
    "lead": "Live status on a small screen",
    "body": "Add a 3.5-inch display and a small USB hub and Haven shows live bandwidth, system health and every connected device on the unit itself. Free, open source, no app or website needed.",
    "family_rank": 7,
    "privacy_rank": 39,
    "family_lead": null,
    "privacy_lead": null,
    "link": "https://lulhaven.com/screen-haven",
    "details": "<p>Screen Haven is a free, open status display that runs on the Haven unit itself. It cycles through six screens &mdash; live download and upload rates on auto-ranging graphs, CPU load, memory and temperature, WAN and LAN status with per-port link lights, every connected device with a live reachability dot, and a quiet clock.</p><p><strong>Press the mouse wheel and it saves a screenshot.</strong> Whatever is on the panel is written as a clean 480&times;320 PNG &mdash; no camera, no glare, no phone held at an angle. Each capture is saved twice: onto the unit, where any admin can view and download it from the Helm, and straight onto a USB stick if one is plugged in.</p><p>The hardware is inexpensive &mdash; a 3.5-inch screen and a small USB hub, because a single USB port has to carry both the screen and a mouse. Any USB or wireless mouse will do. Screen Haven is open source under the MIT license and reads only your own network&rsquo;s state; nothing it displays leaves the unit.</p>",
    "image": null,
    "milestone_ids": null,
