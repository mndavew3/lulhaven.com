var cfDataset = [
  ...
  },
  {
    ...
    "privacy_lead": null,
    "link": null,
    "details": "<p>Every week, Haven pulls down a fresh set of category and provider lists. New gambling fronts, freshly registered scam domains, copy-cat social platforms, new ad networks running mobile game spam — they all land in the lists before they show up in your local environment.</p><p>Bypass tactics get the same treatment. When a new encrypted-DNS provider goes mainstream, when a browser ships a new way of looking up sites that tries to dodge network filters, the next weekly update closes that route. You do not need to do anything; Haven just keeps getting better at the job.</p>",
    "image": null,
  ...
  },
  {
    ...
    "privacy_lead": null,
    "link": null,
    "details": "<p>Haven OD is built on the Linksys E8450 — a well-supported, widely deployed Wi-Fi 6 router that has been a community favorite on OpenWRT for years. Dual-band Wi-Fi 6 (AX3200), four gigabit LAN ports, USB 3. For most setups this is more than enough.</p><p>Pick OD if you want the Haven experience at the lower price point, or if your network has gigabit-class internet rather than multi-gig. The filtering is identical to Navy; the difference is in network capacity at peak load.</p>",
