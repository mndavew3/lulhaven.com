var cfDataset = [
  ...
  },
  {
    ...
    "privacy_lead": null,
    "link": null,
    "details": "<p>Templates are starting points, not lock-ins. Each one flips a thoughtful set of category toggles in a single click — useful when you do not feel like reading every bullet from scratch.</p><ul><li><strong>Caregiver.</strong> Adult content, gambling, mobile game ads, misinformation off by default. Social media on a delayed-allow schedule.</li><li><strong>Fraud.</strong> Scam sites, crypto pump-and-dump, fake-virus pop-ups, fake invoices, \"your computer is infected\" pages — all turned off. Built around the kinds of attacks designed to separate people from their money.</li><li><strong>School.</strong> Homework-time pass that blocks games and social during a configurable window, then opens back up.</li></ul><p>Apply a template, then refine. Anything a template turned on, you can turn back off individually.</p>",
    "image": null,
