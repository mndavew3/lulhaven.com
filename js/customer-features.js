var cfDataset = [
  ...
  },
  {
    ...
    "privacy_lead": null,
    "link": null,
    "details": "<p>Plug in the power, connect to your modem the same way your old router did, set a Wi-Fi password — you are filtering. Haven seeks the same subnet that was in use. No flashing firmware, no following a YouTube tutorial, no command-line, no DNS settings to change on every device in the house.</p><p>The filtering runs at Haven itself, ahead of any device. So filtering is in effect from the very first connection, before a single phone touches the network.</p>",
    "image": null,
  ...
  },
  {
    ...
    "privacy_lead": null,
    "link": null,
    "details": "<p>Your settings live in a partition of Haven that the normal factory reset does not touch. Press and hold the reset button, watch the lights blink, Haven comes back up — with the same filter preferences, the same device list, the same admin accounts.</p><p>This is on purpose. Reset buttons are reachable. We do not want the difference between \"filtered house\" and \"unfiltered house\" to be ten seconds with a paperclip.</p>",
    "image": null,
  ...
  },
  {
    ...
    "body": "When a device leaves your network — on cellular, at school, at a friend's house — your filter accompanies them (requires quick setup on their device).",
    "family_rank": 4,
    "privacy_rank": 33,
    "family_lead": null,
    "privacy_lead": null,
    "link": null,
    "details": "<p>Haven keeps filtering a device after it leaves your network, in two ways &mdash; you pick the one that fits each device:</p><p><strong>Lightweight (recommended).</strong> The device gets a small <em>Private DNS</em> setting that points at Haven. Its name lookups travel over an encrypted WireGuard tunnel to <em>your own home router</em>, which does the filtering exactly as it does on your own network &mdash; ask for a blocked site on cellular and the block still lands. No VPN icon, no battery drain, no app traffic re-routed. Setup is a one-time Private DNS entry; scan the QR on the router&rsquo;s Helm screen and you&rsquo;re finished.</p><p><strong>Full protection (Pro tier).</strong> The phone connects to your router as a private VPN, so every app and connection runs through Haven&rsquo;s filter. The trade-off: a VPN icon in the status bar, slightly more battery, and a few VPN-shy apps may complain.</p><p>Both work where ordinary home VPNs cannot &mdash; including mobile carriers and ISPs that share one public address across many homes (carrier-grade NAT). Haven runs the relay itself; it never sees your traffic in the clear.</p>",
    "image": null,
  ...
  },
  {
    ...
    "privacy_lead": null,
    "link": null,
    "details": "<p>Every week, Haven pulls down a fresh set of category and provider lists. New gambling fronts, freshly registered scam domains, copy-cat social platforms, new ad networks running mobile game spam — they all land in the lists before they show up in your household.</p><p>Bypass tactics get the same treatment. When a new encrypted-DNS provider goes mainstream, when a browser ships a new way of looking up sites that tries to dodge home filters, the next weekly update closes that route. You do not need to do anything; Haven just keeps getting better at the job.</p>",
    "image": null,
  ...
  },
  {
    ...
    "privacy_lead": null,
    "link": null,
    "details": "<p>Haven OD is built on the Linksys E8450 — a well-supported, widely deployed Wi-Fi 6 router that has been a community favorite on OpenWRT for years. Dual-band Wi-Fi 6 (AX3200), four gigabit LAN ports, USB 3. For most households this is more than enough.</p><p>Pick OD if you want the Haven experience at the lower price point, or if your network has gigabit-class internet rather than multi-gig. The filtering is identical to Navy; the difference is in network capacity at peak load.</p>",
  ...
  },
  {
    ...
    "privacy_lead": null,
    "link": null,
    "details": "<p>The Helm runs on Haven and is reachable from inside the home. The Family Dashboard at <strong>family.lulhaven.com</strong> is the outside-the-house companion. Multiple Havens tied to one family account, alerts and a weekly summary consolidated, a \"what got blocked\" view that you can check from work or from a parent helping with a grandparent's house.</p><p>It does not replace the Helm. It does not change router settings remotely. It is a read-and-summarize view designed so the household conversation can happen with the data in front of everyone, not just the person standing in the closet next to the router.</p>",
    "image": null,
    "milestone_ids": null,
    "wiki_slug": null,
    "benefits": []
