...
const STANDARD_STEPS = [
    ...
    [2, 'action', '2a — Plug in and tell Claude to begin',
    ...
    [3, 'action', '2b — Claude verifies router works',
    ...
    [4, 'qc', 'QC-1 Pre-Haven functional test',
    ...
    [5, 'action', 'Flash factory/initramfs image (Stage 1 of 2)',
    ...
    [6, 'action', 'Flash sysupgrade image (Stage 2 of 2)',
    ...
    [8, 'qc', 'QC-2 Bare OpenWrt functional test',
    ...
    [9, 'action', 'Run push-haven.sh <serial>',
    ...
    [10, 'action', 'Verify state.db post-deploy',
    ...
    [11, 'qc', 'QC-3 Haven-installed functional test',
    ...
    [12, 'action', 'Run configure-jason.sh <serial>',
    ...
    [16, 'action', 'Run golden-smoke-test.sh against built unit',
    ...
    [17, 'qc', 'QC-5 Compare built snapshot to golden',
    ...
    [19, 'action', 'Final visual inspection',
