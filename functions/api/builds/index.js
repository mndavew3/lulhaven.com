...
//   POST  create a new build + auto-seed 19 standard steps

// Standard 19-step Haven router build procedure.
// Mirror of haven-build.py STANDARD_STEPS so D1 stays in sync with local.
const STANDARD_STEPS = [
    [1, 'action', 'Receive OEM unit',
    ...
    [2, 'action', 'Power on; confirm OEM firmware reachable',
     'Plug power; connect LAN to dev workstation; confirm router responds at its OEM default IP and OEM web UI loads.',
     'wiki-note-19',
     'OEM web UI reachable; ping succeeds; default credentials available.'],
    [3, 'qc', 'QC-1 Pre-Haven functional test',
    ...
    [4, 'action', 'Flash factory/initramfs image (Stage 1 of 2)',
    ...
    [5, 'action', 'Flash sysupgrade image (Stage 2 of 2)',
    ...
    [7, 'qc', 'QC-2 Bare OpenWrt functional test',
    ...
    [8, 'action', 'Run push-haven.sh <serial>',
    ...
    [9, 'action', 'Verify state.db post-deploy',
    ...
    [10, 'qc', 'QC-3 Haven-installed functional test',
    ...
    [11, 'action', 'Run configure-jason.sh <serial>',
    ...
    [15, 'action', 'Run golden-smoke-test.sh against built unit',
    ...
    [16, 'qc', 'QC-5 Compare built snapshot to golden',
    ...
    [18, 'action', 'Final visual inspection',
...
export async function onRequestPost(context) {
    ...
    // Auto-seed 19 standard steps. Batch for atomicity.
